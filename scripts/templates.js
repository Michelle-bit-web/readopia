    ...
    <section class="section_book_page">
        ...
        <div class="div_like_and_comments">
            <div class="div_like">
                ...
                <img onclick="LikeOrDislike(1,${likes},${i},event)" id="not_liked${i}" class="heart_icon" src="./assets/icon/heart-empty.png" alt="like button">
    ...
    <section class="section_comments">
        ...
        <div class="div_comments">
            ...
            <div class="div_textarea">
                ...
                <img onclick="sendComment(${i})" class="send_icon" src="./assets/icon/send-icon.png" alt="send button">
            </div>
            <br>
        </div>
